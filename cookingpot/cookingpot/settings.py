"""
Django settings for cookingpot project.
...
SECRET_KEY = 'g(b-43d--@^%d0b3d2(p_rbl8fhp9otout1j!!p%1+4w&vu%*j'
...
WSGI_APPLICATION = 'cookingpot.wsgi.application'
